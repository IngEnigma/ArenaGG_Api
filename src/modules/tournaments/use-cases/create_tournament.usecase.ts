...
import { toPrismaGameName, toPrismaTournamentMode } from '../../../common/mappings/to_prisma_enum.mapper';
import { AppLogger } from '../../../common/logger/logger';
import {
  TOURNAMENT_REPOSITORY,
  TournamentRepository,
} from '../interfaces/tournament.repository';
...
export class CreateTournamentUseCase {
  ...
  async execute(data: CreateTournamentDto): Promise<Tournament> {
    try {
      ...
      if (!data.mode || !['Solo', 'Team'].includes(data.mode)) {
