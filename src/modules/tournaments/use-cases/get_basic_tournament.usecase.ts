...
import { TournamentRepository, TOURNAMENT_REPOSITORY } from 'src/modules/tournaments/interfaces/tournament.repository';
...
export class GetBasicTournamentsUseCase {
  constructor(
    ...
    this.logger.setContext(GetBasicTournamentsUseCase.name);
  }
